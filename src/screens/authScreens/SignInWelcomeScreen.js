      ...
      <View style={{}}>
        ...
        <Swiper autoplay={true} style={{ height: 250, }}>
          <View style={styles.slide1}>
            <Image
              source={{ uri: "https://statics.vinpearl.com/dac-san-quang-nam-3_1632893474.png" }}
          ...
          <View style={styles.slide2}>
            <Image
              source={{ uri: "https://statics.vinpearl.com/dac-san-quang-nam-1_1632893384.png" }}
              style={{ height: "100%", width: "100%" }}
            />
          </View>
          ...
          <View style={styles.slide3}>
            <Image
              source={{ uri: "https://statics.vinpearl.com/dac-san-quang-nam-4_1632893520.png" }}
              style={{ height: "100%", width: "100%" }}
            />
          </View>
